        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Create {{ \App\Hook\NotificationHook::getTypeName($type) }} {{ \App\Singleton\HookTypes::getTypeDescription($call_type) }}</h4>
                        </div>
                        <div class="content">
                            @if ($errors->any())
                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            <div class="alert alert-success">
                                Here you can find explanations about the different fields you can use to create the notification you want.
                            </div>

                            <b>Notification name:</b> This is just a name you give this particular notification. It's only purpose is so that you can later edit this notification if you so desire.<br><br>

                            <b>Guild:</b> Here you can select the guild for this notification. Notifications are always guild specific and will only trigger for events in this specific guild.<br><br>

                            @if ($type === \App\Hook\NotificationHook::TYPE_DISCORD)
                                <b>Hook url:</b> This is an url you can obtain in Discord. Open Discord and go to the channel you would like to post the notification to. Click the cog-wheel right of the channel name. In the menu that pops up select the 'Webhooks' option on the left. Create a new one. Give it a name (like 'esoraidplanner', though whatever you name it is irrelevant). There should be a very long url at the bottom. Copy this url and use it in this field. For more information click <a href="https://support.discordapp.com/hc/en-us/articles/228383668-Intro-to-Webhooks" target="_blank">here</a>.<br><br>
                            @elseif ($type === \App\Hook\NotificationHook::TYPE_TELEGRAM)
                                <b>Chat ID:</b> This is the chat id the Telegram bot should post to. If this is a group you will need to get the chat id of that group. This is a little bit of a hassle. You need to log in to <a href="https://web.telegram.org/" target="_blank">Telegram Web</a>.<br><br>
                            @endif
                            @if($call_type === \App\Singleton\HookTypes::ON_TIME)
                                <b>How many minutes before the event should this notification be sent?:</b> Here is where you specify how many minutes before the event starts this notification should be sent. If you for instance set this to 10, the notification will be sent 10 minutes before the event starts.
                            @endif
                        </div>
                    </div>
                </div>
