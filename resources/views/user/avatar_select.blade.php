                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            @if( Auth::user()->membership_level > 0)
                                ...
                                @endif
                                {{ Form::open(array('url' => route('userUpdateAvatar'), 'enctype' => 'multipart/form-data')) }}
                        ...
                        <div class="content">
                            ...
                            {{ Form::open(array('url' => route('userUpdateAvatar'))) }}
                            <?php $i = 0; ?>
                            <table class="table">
                                <tbody>
                                @foreach (\App\Utility\AvatarHelper::all() as $avatar)
                                    @if ($i === 0)
                                        <tr align="center">
                                            @endif
