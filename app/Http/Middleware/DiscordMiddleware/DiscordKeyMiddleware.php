    ...
    public function handle($request, Closure $next)
    {
        ...
        if (null === $user) {
            $user = User::query()
                ...
                ->first();
            if (null === $user) {
                return response(DiscordBotMessages::makeMention($user_discord_long).', I do not know you. Make sure to set your Discord handle in your ESO Raidplanner profile. Your Discord handle is `'.$user_id.'`. Please go here and set your handle: https://esoraidplanner.com/profile/accountsettings', Response::HTTP_BAD_REQUEST);
            }
        }
